...
const isRouteActive = (routeBase) => {
    return route().current(routeBase);
};
</script>
        ...
        <aside class="w-64 bg-white border-r border-gray-200 shadow-lg fixed left-0 top-[80px] bottom-0 overflow-y-auto dark:bg-dark-card dark:border-dark-border hidden lg:block z-10">
            <nav class="p-4 space-y-2">
                ...
                <Link :href="route('dashboard')" 
                      :class="{ 'bg-polban-light text-white': isRouteActive('dashboard'), 'text-gray-700 hover:bg-gray-100 dark:text-dark-muted dark:hover:bg-gray-700/30': !isRouteActive('dashboard') }"
                      class="flex items-center gap-3 px-4 py-3 rounded-lg transition-colors">
                    <svg width="16" height="16" viewBox="0 0 16 16" fill="none" :class="{ 'fill-white': isRouteActive('dashboard'), 'fill-current': !isRouteActive('dashboard') }">
                ...
                <div v-if="user.role === 'operator' || user.role === 'approval'">
                    ...
                    <div class="pt-4 border-t border-gray-200 dark:border-dark-border">
                        ...
                        <Link :href="route('stock-opname.index')" 
                              :class="{ 'bg-polban-light text-white': isRouteActive('stock-opname.*'), 'text-gray-700 hover:bg-gray-100 dark:text-dark-muted dark:hover:bg-gray-700/30': !isRouteActive('stock-opname.*') }"
                              class="flex items-center gap-3 px-4 py-3 rounded-lg w-full transition-colors">
                            <svg width="12" height="16" viewBox="0 0 12 16" fill="currentColor" :class="{ 'text-white': isRouteActive('stock-opname.*') }"><path d="M6 0C4.69375 0 3.58125 0.834375 3.17188 2H2C0.896875 2 0 2.89688 0 4V14C0 15.1031 0.896875 16 2 16H10C11.1031 16 12 15.1031 12 14V4C12 2.89688 11.1031 2 10 2H8.82812C8.41875 0.834375 7.30625 0 6 0ZM6 2C6.26522 2 6.51957 2.10536 6.70711 2.29289C6.89464 2.48043 7 2.73478 7 3C7 3.26522 6.89464 3.51957 6.70711 3.70711C6.51957 3.89464 6.26522 4 6 4C5.73478 4 5.48043 3.89464 5.29289 3.70711C5.10536 3.51957 5 3.26522 5 3C5 2.73478 5.10536 2.48043 5.29289 2.29289C5.48043 2.10536 5.73478 2 6 2ZM9.53125 8.53125L5.53125 12.5312C5.2375 12.825 4.7625 12.825 4.47188 12.5312L2.46875 10.5312C2.175 10.2375 2.175 9.7625 2.46875 9.47188C2.7625 9.18125 3.2375 9.17813 3.52813 9.47188L4.99687 10.9406L8.46875 7.46875C8.7625 7.175 9.2375 7.175 9.52812 7.46875C9.81875 7.7625 9.82187 8.2375 9.52812 8.52812L9.53125 8.53125Z"/></svg>
                            <span class="text-base">Stock Opname</span>
                        </Link>

                        <Link :href="route('barang-usang.index')" 
                              :class="{ 'bg-polban-light text-white': isRouteActive('barang-usang.*'), 'text-gray-700 hover:bg-gray-100 dark:text-dark-muted dark:hover:bg-gray-700/30': !isRouteActive('barang-usang.*') }"
                              class="flex items-center gap-3 px-4 py-3 rounded-lg w-full transition-colors">
                            <svg width="18" height="16" viewBox="0 0 18 16" fill="currentColor" :class="{ 'text-white': isRouteActive('barang-usang.*') }"><path d="M7.75 0H6.5C5.67188 0 5 0.671875 5 1.5V5C5 6.10312 5.89688 7 7 7H11C12.1031 7 13 6.10312 13 5V1.5C13 0.671875 12.3281 0 11.5 0H10.25V2.5C10.25 2.775 10.025 3 9.75 3H8.25C7.975 3 7.75 2.775 7.75 2.5V0ZM2 8C0.896875 8 0 8.89688 0 10V14C0 15.1031 0.896875 16 2 16H7C8.10312 16 9 15.1031 9 14V10C9 8.89688 8.10312 8 7 8H5.75V10.5C5.75 10.775 5.525 11 5.25 11H3.75C3.475 11 3.25 10.775 3.25 10.5V8H2ZM11 16H16C17.1031 16 18 15.1031 18 14V10C18 8.89688 17.1031 8 16 8H14.75V10.5C14.75 10.775 14.525 11 14.25 11H12.75C12.475 11 12.25 10.775 12.25 10.5V8H11C10.5312 8 10.1 8.15937 9.75937 8.43125C9.9125 8.75625 10 9.11875 10 9.5V14.5C10 14.8812 9.9125 15.2438 9.75937 15.5688C10.1 15.8406 10.5312 16 11 16Z"/></svg>
                    ...
                    <div class="pt-4 border-t border-gray-200 dark:border-dark-border">
                        ...
                        <Link :href="route('laporan.permintaan')" 
                            :class="{ 'bg-polban-light text-white': isRouteActive('laporan.permintaan'), 'text-gray-700 hover:bg-gray-100 dark:text-dark-muted dark:hover:bg-gray-700/30': !isRouteActive('laporan.permintaan') }"
                            class="flex items-center gap-3 px-4 py-3 rounded-lg w-full transition-colors">
                            <svg width="16" height="16" viewBox="0 0 16 16" fill="currentColor" :class="{ 'text-white': isRouteActive('laporan.permintaan') }">
                                <path d="M12 0H4C2.9 0 2 0.9 2 2V14C2 15.1 2.9 16 4 16H12C13.1 16 14 15.1 14 14V2C14 0.9 13.1 0 12 0ZM11 13H5V12H11V13ZM11 10H5V9H11V10ZM11 7H5V6H11V7Z"/> 
                            </svg>
                            <span class="text-base">Laporan Permintaan</span>
                        </Link>
                        <Link :href="route('laporan.stock-opname')" 
                            ...
                            class="flex items-center gap-3 px-4 py-3 rounded-lg w-full transition-colors">
                            <svg width="16" height="16" viewBox="0 0 16 16" fill="currentColor" :class="{ 'text-white': isRouteActive('laporan.stock-opname') }">
                                <path d="M12 0H4C2.9 0 2 0.9 2 2V14C2 15.1 2.9 16 4 16H12C13.1 16 14 15.1 14 14V2C14 0.9 13.1 0 12 0ZM11 13H5V12H11V13ZM11 10H5V9H11V10ZM11 7H5V6H11V7Z"/> 
                            </svg>
                ...
                <div v-if="user.role === 'pemohon'">
                    <Link :href="route('permintaan.create')" 
                          :class="{ 'bg-polban-light text-white': isRouteActive('permintaan.create'), 'text-gray-700 hover:bg-gray-100 dark:text-dark-muted dark:hover:bg-gray-700/30': !isRouteActive('permintaan.create') }"
                          class="flex items-center gap-3 px-4 py-3 rounded-lg w-full transition-colors">
                        <svg width="16" height="16" viewBox="0 0 16 16" fill="currentColor" :class="{ 'text-white': isRouteActive('permintaan.create') }"><path d="M8 16C10.1217 16 12.1566 15.1571 13.6569 13.6569C15.1571 12.1566 16 10.1217 16 8C16 5.87827 15.1571 3.84344 13.6569 2.34315C12.1566 0.842855 10.1217 0 8 0C5.87827 0 3.84344 0.842855 2.34315 2.34315C0.842855 3.84344 0 5.87827 0 8C0 10.1217 0.842855 12.1566 2.34315 13.6569C3.84344 15.1571 5.87827 16 8 16ZM7.25 10.75V8.75H5.25C4.83437 8.75 4.5 8.41562 4.5 8C4.5 7.58437 4.83437 7.25 5.25 7.25H7.25V5.25C7.25 4.83437 7.58437 4.5 8 4.5C8.41562 4.5 8.75 4.83437 8.75 5.25V7.25H10.75C11.1656 7.25 11.5 7.58437 11.5 8C11.5 8.41562 11.1656 8.75 10.75 8.75H8.75V10.75C8.75 11.1656 8.41562 11.5 8 11.5C7.58437 11.5 7.25 11.1656 7.25 10.75Z"/></svg>
                        <span class="text-base">Ajukan Barang</span>
                    </Link>
                    
                    <Link :href="route('permintaan.riwayat')" 
                          :class="{ 'bg-polban-light text-white': isRouteActive('permintaan.riwayat'), 'text-gray-700 hover:bg-gray-100 dark:text-dark-muted dark:hover:bg-gray-700/30': !isRouteActive('permintaan.riwayat') }"
                          class="flex items-center gap-3 px-4 py-3 rounded-lg w-full transition-colors">
                        <svg width="16" height="16" viewBox="0 0 16 16" fill="currentColor" :class="{ 'text-white': isRouteActive('permintaan.riwayat') }"><path d="M2.34375 2.34375L1.28125 1.28125C0.809375 0.809375 0 1.14375 0 1.80938V5.25C0 5.66563 0.334375 6 0.75 6H4.19063C4.85938 6 5.19375 5.19063 4.72188 4.71875L3.75938 3.75625C4.84375 2.67188 6.34375 2 8 2C11.3125 2 14 4.6875 14 8C14 11.3125 11.3125 14 8 14C6.725 14 5.54375 13.6031 4.57188 12.925C4.11875 12.6094 3.49687 12.7188 3.17812 13.1719C2.85938 13.625 2.97187 14.2469 3.425 14.5656C4.725 15.4688 6.30312 16 8 16C12.4187 16 16 12.4187 16 8C16 3.58125 12.4187 0 8 0C5.79063 0 3.79063 0.896875 2.34375 2.34375ZM8 4C7.58437 4 7.25 4.33437 7.25 4.75V8C7.25 8.2 7.32812 8.39062 7.46875 8.53125L9.71875 10.7812C10.0125 11.075 10.4875 11.075 10.7781 10.7812C11.0687 10.4875 11.0719 10.0125 10.7781 9.72188L8.74687 7.69063V4.75C8.74687 4.33437 8.4125 4 7.99687 4H8Z"/></svg>
                ...
                <div class="flex items-center justify-between px-6 py-4">
                    ...
                    <!-- <div class="flex-1 max-w-md mx-8 hidden md:block">
                        <div class="relative">
                            ...
                            <TextInput
                                type="text"
                                placeholder="Cari barang, kelompok barang..."
                            ...
                            <Dropdown align="right" width="48">
                                <template #trigger>
                                    <button class="flex items-center gap-3 cursor-pointer focus:outline-none focus:ring-0 border-none bg-transparent transition ease-in-out duration-150">
                                        ...
                                        <svg width="14" height="14" viewBox="0 0 14 14" fill="#9CA3AF" class="hidden md:block dark:fill-dark-muted transition-transform duration-200">
                    ...
                    <div class="border-t border-base-300 pt-4">
                        <div class="flex items-center gap-3 px-2 mb-4">
                            <div class="avatar placeholder">
                                <div class="bg-gray-200 text-gray-600 rounded-full w-10 flex items-center justify-center">
                                    <span class="text-sm font-bold">{{ user.name.charAt(0) }}</span>
                                </div>
                            </div>
                            <div>
                                <p class="font-bold text-sm text-gray-800 dark:text-gray-200">{{ user.name }}</p>
                                <p class="text-xs text-gray-500 capitalize">{{ user.role }}</p>
                            </div>
                        </div>
                        <Link :href="route('logout')" method="post" as="button" class="flex items-center gap-2 text-red-600 font-medium px-2 w-full text-left">
