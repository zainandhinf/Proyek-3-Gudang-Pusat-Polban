            ...
            <nav class="p-4 space-y-2">
                ...
                <div v-if="user.role === 'operator' || user.role === 'approval'">
                    <div class="pt-4 border-t border-gray-200 dark:border-dark-border">
                        ...
                        <Link :href="route('satuans.index')" class="flex items-center gap-3 px-4 py-3 rounded-lg text-gray-700 hover:bg-gray-100 w-full transition-colors dark:text-dark-muted dark:hover:bg-gray-700/30">
                        ...
                        <Link :href="route('barangs.index')" class="flex items-center gap-3 px-4 py-3 rounded-lg text-gray-700 hover:bg-gray-100 w-full transition-colors dark:text-dark-muted dark:hover:bg-gray-700/30">
                    ...
                    <div class="pt-4 border-t border-gray-200 dark:border-dark-border">
                        ...
                        <Link :href="route('mutasi-barang.index')" class="flex items-center gap-3 px-4 py-3 rounded-lg text-gray-700 hover:bg-gray-100 w-full transition-colors dark:text-dark-muted dark:hover:bg-gray-700/30">
                        ...
                        <Link :href="route('permintaan.index')" class="flex items-center gap-3 px-4 py-3 rounded-lg text-gray-700 hover:bg-gray-100 w-full transition-colors dark:text-dark-muted dark:hover:bg-gray-700/30">
                ...
                <div v-if="user.role === 'pemohon'">
                    <Link :href="route('permintaan.create')" class="flex items-center gap-3 px-4 py-3 rounded-lg text-gray-700 hover:bg-gray-100 w-full transition-colors dark:text-dark-muted dark:hover:bg-gray-700/30">
                    ...
                    <Link :href="route('permintaan.riwayat')" class="flex items-center gap-3 px-4 py-3 rounded-lg text-gray-700 hover:bg-gray-100 w-full transition-colors dark:text-dark-muted dark:hover:bg-gray-700/30">
