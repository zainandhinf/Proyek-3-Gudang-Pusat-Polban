...
<template>
    <Head title="Tambah Akun Pemohon" />
    ...
    <AuthenticatedLayout>
        <div class="py-8 px-4 md:px-6 lg:px-8 max-w-4xl mx-auto">
            ...
            <div class="mb-6">
                ...
                <h1 class="text-2xl font-bold text-gray-900">Tambah Akun Pemohon</h1>
            </div>
                ...
                <div class="p-6">
                    <form @submit.prevent="submit">
                        ...
                        <div class="flex items-center justify-end gap-3 pt-6 border-t border-gray-100">
                            <Link 
                                :href="route('manajemen-akun.pemohon.index')" 
