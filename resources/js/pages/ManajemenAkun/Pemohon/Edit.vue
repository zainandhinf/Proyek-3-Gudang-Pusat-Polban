...
<template>
    ...
    <AuthenticatedLayout>
        <div class="py-8 px-4 md:px-6 lg:px-8 max-w-4xl mx-auto">
            ...
            <div class="mb-6">
                <Link :href="route('manajemen-akun.pemohon.index')" class="flex items-center text-gray-500 hover:text-gray-700 transition mb-2">
                ...
                <div class="p-6">
                    <form @submit.prevent="submit">
                        ...
                        <div class="flex justify-end gap-3 pt-2">
                            <Link :href="route('manajemen-akun.pemohon.index')" class="px-4 py-2 border border-gray-300 rounded-lg text-gray-700 text-sm font-medium hover:bg-gray-50 transition">Batal</Link>
