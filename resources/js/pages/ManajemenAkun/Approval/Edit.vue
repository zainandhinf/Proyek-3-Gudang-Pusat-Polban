        ...
        <div class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                    ...
                    <h2 class="text-2xl font-bold mb-6 text-gray-800">Edit Approval: {{ user.name }}</h2>
                    ...
                    <form @submit.prevent="submit">
                        ...
                        <div class="flex justify-end gap-3">
                            <Link :href="route('manajemen-akun.approval.index')" class="px-4 py-2 text-gray-600 font-medium">Batal</Link>
