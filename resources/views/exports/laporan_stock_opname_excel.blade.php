<table>
    {{-- HEADER RESMI --}}
    <tr>
        <td colspan="8" style="font-weight: bold; font-size: 14px; text-align: center;">POLITEKNIK NEGERI BANDUNG</td>
    </tr>
    <tr>
        <td colspan="8" style="font-weight: bold; text-align: center;">SUBBAGIAN TATA USAHA - URUSAN ASET DAN RUMAH TANGGA</td>
    </tr>
    <tr></tr>
    <tr>
    ...
    <tbody>
        ...
        <tr>
            ...
            {{-- Warna Merah Jika Ada Selisih (Menggunakan Style Inline HTML Excel) --}}
            <td style="border: 1px solid #000; text-align: center; {{ $detail->selisih != 0 ? 'color: #FF0000; font-weight: bold;' : '' }}">
