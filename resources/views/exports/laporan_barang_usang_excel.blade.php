<table>
    {{-- HEADER RESMI --}}
    <tr>
        <td colspan="7" style="font-weight: bold; font-size: 14px; text-align: center;">POLITEKNIK NEGERI BANDUNG</td>
    </tr>
    <tr>
        <td colspan="7" style="font-weight: bold; text-align: center;">SUBBAGIAN TATA USAHA - URUSAN ASET DAN RUMAH TANGGA</td>
    </tr>
    <tr></tr>
    <tr>
    ...
    <tbody>
        ...
        {{-- Spacer Rows untuk keindahan cetak --}}
